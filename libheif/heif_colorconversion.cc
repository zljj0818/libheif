...
public:
  ...
  convert_colorspace(const std::shared_ptr<const HeifPixelImage>& input,
                     ColorState target_state,
                     ColorConversionOptions options) override;
  const char* name() const override { return "Op_YCbCr420_to_RGB_8bit";  }
};
...
public:
  ...
  convert_colorspace(const std::shared_ptr<const HeifPixelImage>& input,
                     ColorState target_state,
                     ColorConversionOptions options) override;
  const char* name() const override { return "Op_YCbCr420_to_RGB_16bit";  }
};
...
public:
  ...
  convert_colorspace(const std::shared_ptr<const HeifPixelImage>& input,
                     ColorState target_state,
                     ColorConversionOptions options) override;
  const char* name() const override { return "Op_YCbCr422_to_RGB_16bit";  }
};
...
public:
  ...
  convert_colorspace(const std::shared_ptr<const HeifPixelImage>& input,
                     ColorState target_state,
                     ColorConversionOptions options) override;
  const char* name() const override { return "Op_RGB_HDR_to_YCbCr420";  }
};
